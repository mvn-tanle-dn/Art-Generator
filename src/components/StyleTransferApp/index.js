...
class StyleTransferApp extends React.Component {
  constructor(props) {
    ...
    this.styleTranferModel.setValueAccessors(
      this.contentRef,
      this.styleRef,
      this.outputRef
    );
  ...
  resetAndBegin = () => {
    this.setState(
      ...
      () => {
        this.styleTranferModel.generateStyledImage(
          this.state.strength,
          (styledImage) => {
            this.setState({
              stepper: -1,
          ...
          () => {
            this.setState({
              snackbarMessage: "Error generating image",
              isDisabled: false,
            });
          }
        );
      ...
      <div className="container expanded-content">
        <div className="inputs">
          <ContentImageSelector
            ...
            refObject={this.contentRef}
          />
          <StyleImageSelector
            isDisabled={this.state.isDisabled}
            refObject={this.styleRef}
          />
        </div>
        <br />
          ...
          <div className="selector-container">
            ...
            >
              ...
              {/* <HelpOutlineOutlinedIcon
                ...
                aria-owns={
                  this.state.anchorEl ? "mouse-over-popover" : undefined
                }
                aria-haspopup="true"
              ...
              >
                <Typography style={{ maxWidth: 200, textAlign: "center" }}>
                  Stylization strength is the degree of stylization that is
                  applied. Going left inclines the output closer to the content
                  image while going right deviates it more towards the style
                  image.
                </Typography>
              </Popover> */}
              ...
              >
                {this.state.loading === -2 ? "Downloading Model" : "Render"}
              </Button>
              <br />
            </div>
          </div>
